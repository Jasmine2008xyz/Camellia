     ...
     // 定义一个设置项列表
        ...
        init {
          ...
          //  settingsItemList.add(SettingOpt(settingsItemList.size,"屏蔽回复表情展示",SettingOpt.TYPE_SWITCH))
            ...
            settingsItemList.add(SettingOpt(settingsItemList.size,"复制图片链接",SettingOpt.TYPE_SWITCH))
            settingsItemList.add(SettingOpt(settingsItemList.size,"聊天头像助手",SettingOpt.TYPE_SWITCH))
