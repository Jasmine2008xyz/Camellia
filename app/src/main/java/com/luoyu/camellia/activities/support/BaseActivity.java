...
public class BaseActivity extends FragmentActivity {
    private final BaseActivityClassLoader mLoader =
            new BaseActivityClassLoader(BaseActivity.class.getClassLoader());
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        XRes.addAssetsPath((Context)this);
    }
    ...
    private static class BaseActivityClassLoader extends ClassLoader {
        ...
        public BaseActivityClassLoader(ClassLoader referencer) {
            ...
            mHostReferencer = ActivityProxyManager.HostClassLoader;
        }
        ...
        protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
            ...
            try {
                // start: overloaded
                if (name.equals("androidx.lifecycle.LifecycleOwner")
                        || name.equals("androidx.lifecycle.ViewModelStoreOwner")
                        || name.equals("androidx.savedstate.SavedStateRegistryOwner")) {
