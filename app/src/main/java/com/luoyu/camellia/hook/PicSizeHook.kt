...
class PicSizeHook {
    ...
    fun start() {
        ...
        XposedBridge.hookMethod(method, object : XC_MethodHook() {
            override fun beforeHookedMethod(param: MethodHookParam) {
                ...
                val isEnabled = MItem.Config.getBooleanData("修改图片大小/开关", false)
                if(!isEnabled) return
                ...
                // 使用反射设置字段值
                    ...
                    val setValueHeight = MItem.Config.getIntData("修改图片大小/height",-1)
                    val setValueWidth = MItem.Config.getIntData("修改图片大小/width",-1)
    ...
    fun onLongClick(){
        ...
        val width_cache = MItem.Config.getIntData("修改图片大小/width",-1)
        if(width_cache == -1)
        edit_view.setText("")
        ...
        val height_cache = MItem.Config.getIntData("修改图片大小/height",-1)
        ...
        MaterialAlertDialogBuilder(context) 
            ...
            .setPositiveButton("Leave") {
             ...
             .setNeutralButton("保存") { _ , _ ->
              ...
              MItem.Config.putData("修改图片大小/width",Integer.parseInt(edit_view.getText().toString()))
               MItem.Config.putData("修改图片大小/height",Integer.parseInt(edit_view2.getText().toString()))
             }
            .show()
    }
}